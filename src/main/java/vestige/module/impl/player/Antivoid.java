...
public class Antivoid extends Module {
    ...
    public void onEnable() {
        collisionBlock = null;
        lastSafePos = new PlayerInfo(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ,
                ...
                mc.thePlayer.fallDistance, mc.thePlayer.inventory.currentItem);
    }
    ...
    public void onTick(TickEvent event) {
        ...
        switch (mode.getMode()) {
            ...
            case "Collision flag":
                if (shouldSetback()) {
                    if (collisionBlock != null) mc.theWorld.setBlockToAir(collisionBlock);
    ...
    public void onReceive(PacketReceiveEvent event) {
        if (event.getPacket() instanceof S08PacketPlayerPosLook) {
            ...
            if (mode.is("Blink") && blinking) {
                ...
                lastSafePos = new PlayerInfo(packet.getX(), packet.getY(), packet.getZ(),
                        0, 0, 0, packet.getYaw(), packet.getPitch(),
                        false, mc.thePlayer.fallDistance, mc.thePlayer.inventory.currentItem);
    ...
    private boolean isSafe() {
        return WorldUtil.isBlockUnder() || !mc.getNetHandler().doneLoadingTerrain || mc.thePlayer.ticksExisted < 100
                || (flyModule != null && flyModule.isEnabled())
