...
public class InventoryManager extends Module {
    ...
    private final ModeSetting mode = new ModeSetting("Mode", "OpenInv", "OpenInv", "SpoofInv");
    ...
    public InventoryManager() {
        ...
        this.addSettings(mode, delaySetting, weapon_slot, axe_slot, pickaxe_slot, shovel_slot, block_stack_slot, golden_apples_slot);
    }
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        boolean canManage = mode.is("SpoofInv") || (mode.is("OpenInv") && mc.currentScreen instanceof GuiInventory);
