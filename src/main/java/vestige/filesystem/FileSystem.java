...
public class FileSystem {
    ...
    public FileSystem() {
        ...
        vestigeDir = new File(mcDir, "Tellurium");
    ...
    public void saveConfig(String configName) {
        ...
        try {
            File configFile = new File(vestigeConfigDir, configName + ".nga");
    ...
    public void saveKeybinds() {
        try {
            File keybindsFile = new File(vestigeDir, "keybinds.nga");
